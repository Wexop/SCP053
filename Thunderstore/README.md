...
Here is how SCP053 work !

- She walks around like any monster
- If she sees a player, the player will start to hate her, and she will be scared. Player is forced to look at her and can't move for a few seconds. When player can finally move, he needs to run out of her line of sight. After a moment, if she still sees the player, she'll come in front of the player and kill him.
- If the player has been seen by SCP053 once, he will be cursed and will hate every player he sees. If a cursed player sees another one, this another player will take few damages. 

If SCP682 is also in the game, SCP053 will follow him (only in factory)
